    ...
    <ul class="c-sidebar-nav ps ps--active-y">
        ...
        <li class="c-sidebar-nav-item c-sidebar-nav-dropdown">
            <a class="c-sidebar-nav-link" href="{{ route('admin.pages.index') }}">
                <svg class="c-sidebar-nav-icon">
                    <use xlink:href="{{
                            asset(
                                'vendors/@coreui/icons/svg/free.svg#cil-puzzle'
                            )
                        }}"></use>
                </svg>{{ __("Pages") }}
            </a>
        ...
        <li class=" c-sidebar-nav-item c-sidebar-nav-dropdown c-show
            ...
            <ul class="c-sidebar-nav-dropdown-items">
                ...
                <li class="c-sidebar-nav-item c-show">
                    <a class="c-sidebar-nav-link" href="{{ route('admin.checklist_groups.checklists.edit',[$group,$checklist]) }}"><span
        ...
        <li class="c-sidebar-nav-item c-sidebar-nav-dropdown">
            ...
            <ul class="c-sidebar-nav-dropdown-items">
                <li class="c-sidebar-nav-item">
                    <a class="c-sidebar-nav-link" href="base/breadcrumb.html"><span class="c-sidebar-nav-icon"></span>
                        {{ __("Breadcrumb") }}</a>
                </li>
            </ul>
        </li>
